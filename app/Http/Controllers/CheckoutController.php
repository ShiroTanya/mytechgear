...
class CheckoutController extends Controller
{
    ...
    public function order_place(Request $request)
    {
        ...
        //Them du lieu dat hang
        $order_data = array();
        $order_data['customer_id'] = Session::get('customer_id');
        $order_data['shipping_id'] = Session::get('shipping_id');
        $order_data['payment_id'] = $payment_id;
        $order_data['order_total'] = Cart::priceTotal(0); //Xem lai tong tien 36.1
        $order_data['order_status'] = 'Đang chờ xử lý';
        $order_id = DB::table('tbl_order')->insertGetId($order_data);


        $content = Cart::content(); //truyen vao bien content tu show_cart
        foreach($content as $v_content){
            ...
            DB::table('tbl_order_details')->insert($order_d_data);      //Insert ket qua vao trong table Order D
        }

        //Neu ko co foreach se chi chay san pham cuoi cung 
    ...
    {
        //lay tu Product controller all product
        $this->AuthLogin();
