...
//---------end MAIL CONFIRM
        ...
        //order_date so sanh orderdate statistic...(neu ton tai -> dem')
            ...
            foreach($data['order_product_id'] as $key => $product_id){
                ...
                foreach($data['quantity'] as $key2 => $qty){
                        if($key==$key2){
                                ...
                                $product->save();
                                //update doanh thu
                                $quantity+=$qty; //tinh tong so luong trong manageorder
    ...
    public function print_order_convert($checkout_code){
        ...
        // $output.='  
        // <tr>
        //     <td colspan="4">Phạm Hoàng Long</td>
        //     <td></td>
    ...
    public function view_order($order_code){
        ...
        $customer = Customer::where('customer_id',$customer_id)->first(); //chi lay 1 dong nen ko can foreach
        $shipping = Shipping::where('shipping_id',$shipping_id)->first();
    ...
    public function history(Request $request){
        ...
        return view('pages.history.history')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('category_post',$category_post)->with('order',$order); 
        }
