...
@section('content')
<div>
  <h2 class="title text-center">Chi tiết đơn hàng của bạn</h2>
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}"> {{-- doi mau cho class tr khi ko du so luong --}}
            ...
            <td>
              ...
              <input type="text" min="1" {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" name="product_sales_quantity">
