                    ...
                    <div class="panel-body">
                      ...
                      <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$edit_value->category_name}}" data-validation="length" data-validation-length="min1" data-validation-error-msg="Tên danh mục không được để trống" name="category_product_name" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục">
                                </div>
                                 <div class="form-group">
                                ...
                                <select name="category_parent" class="form-control input-sm m-bot15">
                                    <option value="0">------Danh mục cha (GỐC)------</option>
