  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa danh mục này?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
            </td>
          </tr>
          @endforeach
      ...
      <form action="{{url('import-csv')}}" method="POST" enctype="multipart/form-data">
       ...
       <input type="submit" value="Thêm danh mục từ file Excel" name="import_csv" class="btn btn-warning">
      </form>

    <!-----export data---->
       <form action="{{url('export-csv')}}" method="POST">
          @csrf
       <input type="submit" value="Xuất danh mục ra file Excel" name="export_csv" class="btn btn-success">
      </form>
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        {{-- <div class="col-sm-5 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">Hiển thị 20 trên 30 sản phẩm</small>
        </div> --}}
