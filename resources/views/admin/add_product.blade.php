            ...
            <div class="col-lg-12">
                    <section class="panel">
                      ...
                      <div class="position-center">
                                ...
                                {{-- <div class="form-group">
                                    <label for="exampleInputEmail1">SL đã tiêu thụ</label>
                                ...
                                <div class="form-group">
                                <label for="emxampleInputPassword1"> Danh mục sản phẩm </label>
                                ...
                                <div class="form-group">
                                <label for="emxampleInputPassword1"> Thương hiệu </label>
