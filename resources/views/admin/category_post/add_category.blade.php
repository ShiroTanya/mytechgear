                    ...
                    <section class="panel">
                      ...
                      <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length" data-validation-length="min1" data-validation-error-msg="Tên danh mục không được để trống" name="cate_post_name"  class="form-control" onkeyup="ChangeToSlug();" id="slug" placeholder="Tên thương hiệu">
                                </div>
                                <div class="form-group">
