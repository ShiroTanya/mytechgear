...
<body>
	<div class="container" style="background: #222;border-radius: 12px;padding: 15px;">
		<div class="col-md-12">
			...
			<div class="row" style="background: dimgrey;padding: 15px">
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					...
					<div class="col-md-6 logo" style="color: #fff">
						<p>Chào bạn <strong style="color: #000;text-decoration: underline;">{{$shipping_array['customer_name']}}</strong>, chúng tôi đã xác nhận đơn hàng của bạn với những thông tin sau:</p>
					</div>
					...
					<div class="col-md-12">
						...
						<p> Phí vận chuyển: <strong style="text-transform: uppercase;color: #fff">{{$shipping_array['fee_ship']}}</strong></p>
						...
						<h4 style="color: #fff;text-transform: uppercase;">Đơn hàng xác nhận với các thông tin sau: </h4>
